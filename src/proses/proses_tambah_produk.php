...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama_produk) || $harga === '' || $stok === '') {
        tampilkanUI('error', 'Data Tidak Lengkap', 'Pastikan nama, harga, dan stok produk sudah diisi semua.', $url_kembali);
    }
    ...
    try {
        ...
        tampilkanUI('success', 'Produk Disimpan!', "Barang <b>{$nama_produk}</b> berhasil ditambahkan ke dalam etalase.", $url_kembali . '?pesan=sukses');
